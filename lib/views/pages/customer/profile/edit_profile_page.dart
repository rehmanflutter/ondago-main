...
class CustomerEditProfilePage extends StatefulWidget {
  ...
  @override
  State<CustomerEditProfilePage> createState() => _EditProfilePageState();
}

class _EditProfilePageState extends State<CustomerEditProfilePage> {
      ...
      body: SizedBox.expand(
        child: Column(
          children: [
            ...
            const Spacer(),
            Obx(
              () => customerController.isProfileEdit.value
                  ? const Center(
